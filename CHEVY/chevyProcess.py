...
fl_plan = pd.read_excel(r'C:\Users\lsend\dev\py\sam\CHEVY\CHEVY FP REC 052023.xls')

#bank_account = pd.read_excel( r'C:\Users\lsend\dev\py\sam\FLOORPLAN REC milford.xls',sheet_name='sheet1')
bank_account = pd.read_excel( r'C:\Users\lsend\dev\py\sam\CHEVY\61971_DLR_20230531 CHEVY.xls',sheet_name='sheet1')

writer = pd.ExcelWriter(r'C:\Users\lsend\dev\py\sam\CHEVY\chevy_rec.xlsx', engine='xlsxwriter')
