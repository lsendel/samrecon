...
fl_plan = pd.read_excel(r'C:\Users\lsend\dev\py\sam\MILFORD\MILFORD FP REC 052023.xls')

#bank_account = pd.read_excel( r'C:\Users\lsend\dev\py\sam\FLOORPLAN REC milford.xls',sheet_name='sheet1')
bank_account = pd.read_excel( r'C:\Users\lsend\dev\py\sam\MILFORD\61969_DLR_20230531 MILFORD.xls',sheet_name='sheet1')

writer = pd.ExcelWriter(r'C:\Users\lsend\dev\py\sam\MILFORD\milford_rec.xlsx', engine='xlsxwriter')
